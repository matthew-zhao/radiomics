...
def classify(event, context):
    ...
    # creating the model is done here
        ...
        X_train = tf.placeholder(tf.float32, [batch_size, event["xscale"], event["yscale"], int(event["num_channels"])], name="X_train")
        ...
        model = unet.create_unet(X_train, mode)
        ...
        cost = unet.loss_dice(prediction, y_train, name="predict")
